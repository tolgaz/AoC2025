...
Kotlin solution for Day 7 of Advent of Code.

## Setup

No setup needed! Gradle wrapper handles everything.
...
- `src/main/kotlin/Main.kt` - Main solution functions and entry point
- `src/test/kotlin/SolutionTest.kt` - Test cases
